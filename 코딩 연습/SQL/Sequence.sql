...
-- 이 테이블에 PK를 2025-00001 형식으로 INSERT하려고 함
-- 다음 값은 2025-00002 형식이 됨
-- 시퀀스를 만들고, INSERT를 넣을때 위 형식처럼 값이 들어갈 수 있도록 INSERT를 넣어주세요.
CREATE SEQUENCE EMPS2_SEQ
    INCREMENT BY 1
    START WITH 1
    MINVALUE 1
    MAXVALUE 99999
    ...
    NOCACHE
;
INSERT INTO EMPS2 VALUES('2025-'||LPAD(TO_CHAR(EMPS2_SEQ.NEXTVAL),5,'0'),'EXAMPLE');
SELECT * FROM EMPS2;