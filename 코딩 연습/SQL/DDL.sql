...
-- DROP : 테이블 삭제
DROP TABLE EMPS;
DROP TABLE DEPARTMENTS; -- DEPARTMENTS 테이블은 EMPLOYEES 테이블과 제약조건이 연결되어 있어, 삭제불가
-- DROP TABLE 테이블명 CASCADE 제약조건명; -- 제약조건이라는 것을 삭제하면서 테이블을 지움
...
INSERT INTO DEPT2 VALUES(10,'EX',1123,'M',SYSDATE,12.12345);
INSERT INTO DEPT2 VALUES(10,'EX',1123,'M',SYSDATE,12345.12345);