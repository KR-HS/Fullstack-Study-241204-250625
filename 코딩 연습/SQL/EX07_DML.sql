...
MERGE INTO DEPTS D1
USING (SELECT DEPARTMENT_ID,DEPARTMENT_NAME,MANAGER_ID,LOCATION_ID FROM DEPARTMENTS)D2
...
SELECT * FROM JOBS;
CREATE TABLE JOBS_IT AS SELECT JOB_ID,JOB_TITLE,MIN_SALARY,MAX_SALARY FROM JOBS WHERE MIN_SALARY>=6000;
...
USING (SELECT JOB_ID,JOB_TITLE,MIN_SALARY,MAX_SALARY FROM JOBS WHERE MIN_SALARY>=0)J2
